...
public class Client {
	...
	public class SocketThread extends Thread {
		// Создаёт вспомогательный поток SocketThread, ожидает пока установится соединение с сервером,
		// а после этого в цикле считывать сообщения с консоли и отправляет их серверу.
		...
		// используется методы wait() и notify().
